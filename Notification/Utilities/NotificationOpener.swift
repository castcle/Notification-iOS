...
public struct NotificationOpener {
    public static func open(_ notificationScene: NotificationScene) -> UIViewController {
        ...
        case .notificationList(let viewModel):
            ...
            return viewController ?? NotificationListViewController()
        }
    }
}
